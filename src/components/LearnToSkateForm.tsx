...
const STATE_OPTIONS = [
  ...
  { value: "52", label: "AE" },
  { value: "53", label: "Alberta" },
  { value: "54", label: "British Columbia" },
  { value: "55", label: "Manitoba" },
  { value: "56", label: "New Brunswick" },
  { value: "57", label: "Newfoundland & Labrador" },
  { value: "58", label: "Northwest Territories" },
  { value: "59", label: "Nova Scotia" },
  { value: "60", label: "Nunavut" },
  { value: "61", label: "Ontario" },
  { value: "62", label: "Prince Edward Island" },
  { value: "63", label: "Quebec" },
  { value: "64", label: "Saskatchewan" },
  { value: "65", label: "Yukon" },
  { value: "66", label: "Nuevo Leon" },
  { value: "67", label: "PQ" },
  { value: "68", label: "AP" },
  { value: "69", label: "AA" },
];
